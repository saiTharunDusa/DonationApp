...
const initialState = {
    ...
    selectedDonationItemId : 1,
    selectedDonationInformation : {}
}


const donationItems = createSlice({
    name : 'donationItem',
...
export const {resetDonations, updateSelectedDonationId} = donationItems.actions;

export default donationItems.reducer;
